...
<template>
    <div class="w-full h-20 flex justify-between items-center">
        <div class="w-[30%]">
            <nuxt-link to="/"><img src="/logo.png" class="w-36 h-9"/></nuxt-link>
        </div>
        <div class="w-[40%] flex items-center justify-center">
            <ul class="flex items-center justify-between w-[80%]">
                <li class="text-[#3D3D3D] text-2xl font-bold"><nuxt-link to="/">Home</nuxt-link></li>
                <li class="text-[#3D3D3D] text-xl font-medium"><nuxt-link to="/shop">Shop</nuxt-link></li>
                <li class="text-[#3D3D3D] text-xl font-medium"><nuxt-link to="/plant-care">Plant Care</nuxt-link></li>
                <li class="text-[#3D3D3D] text-xl font-medium"><nuxt-link to="/blogs">Blogs</nuxt-link></li>
            </ul>
        </div>
            ...
            <div class="flex justify-between items-center">
                ...
                <button class="bg-[#46A358] flex">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M13.6342 6.35823C13.3592 3.3749 12.2425 2.29156 7.80082 2.29156C1.88332 2.29156 1.88332 4.21656 1.88332 9.9999C1.88332 15.7832 1.88332 17.7082 7.80082 17.7082C12.2425 17.7082 13.3592 16.6249 13.6342 13.6416" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Login 
                </button>
